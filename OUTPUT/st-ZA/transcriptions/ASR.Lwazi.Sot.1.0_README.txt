...
per language and 30 utterances per speaker,  14 of which 
are elicited speech and the others are read speech. The 
...
METADATA.csv	       -    Text file containing metadata regarding landline/modile, age and gender as available
